...
layout: talks
title: Talks
subtitle: Conference talks, meetup presentations, and podcast appearances.
permalink: /talks/
---
...
- `2024-10-08` [JumpIT](https://www.jumpitforum.com/) — CTIO Talk panel: Umjetna inteligencija, kiberneticka sigurnost, tehnoloski trendovi
...
- `2023-11-30` [Software Engineering Daily](https://www.youtube.com/watch?v=3aiDs1o6m20&ab_channel=SoftwareEngineeringDaily) — Podcast appearance
...
- `2023-02-02` [Bug Future Show](https://www.bug.hr/dogadjaji/ovo-je-kompletan-program-najspektakularnijeg-bug-future-showa-svih-vremena-31389) — Scaling infrastructure for millions of users without breaking the bank ([video](https://www.youtube.com/watch?v=P7F6DjRIJkc&ab_channel=BugTV))
...
- `2022-10-07` [The Geek Gathering](https://thegeekgathering.org/schedule) — Scaling: from 0 to 20 million
- `2022-06-24` [Dutch PHP Conference](https://www.phpconference.nl/talk/scaling-from-0-o-20-million-users) — Scaling: from 0 to 20 million ([video](https://www.youtube.com/watch?v=82R0GvERY20))
- `2022-06-09` [PHP Meetup](https://www.meetup.com/zgphp-meetup/events/285508799/) — Advanced caching
- `2022-05-20` [DORS/CLUC](https://2022.dorscluc.org/2022/05/10/talk-announcement-josip-stuhli-scaling-from-0-to-20-million-users/) — Scaling: from 0 to 20 million ([video](https://www.youtube.com/watch?v=IA_9KgkXkD8))
- `2022-05-15` [JavaCRO](https://2022spring.javacro.hr/eng/Program/Scaling-0-to-20-million-users) — Keynote: Scaling from 0 to 20 million

## 2021

- `2021-09-02` [Web Summer Camp](https://2021.websummercamp.com/php) — Advanced caching practices workshop
- `2021-06-10` [Debug](https://www.debug.hr/2021/) — Scaling: from 0 to 20 million ([video](https://www.youtube.com/watch?v=vMBrxYU_keI&list=TLGGP6TwW1LVBnowNjA5MjAyMQ&t=1s&ab_channel=BugTV))
- `2021-05-14` [FER (Faculty of Electrical Engineering)](https://www.fer.unizg.hr/en) — Scaling: from 0 to 20 million
- `2021-05-02` [Tech Radar #101](https://www.youtube.com/watch?v=YHjosNEPK5s&list=PLFzhEM4ssFwASDLgotmhE15-GbT_BRjDb) — Kako je SofaScore prikupio 20 milijuna korisnika i prosirio se na kinesko trziste? ([video](https://www.youtube.com/watch?v=X-PGr_I9XyM&t=2s&ab_channel=BugTV))
...
- `2019-11-28` [PHP Meetup](https://www.meetup.com/ZgPHP-meetup/events/266578670/) — Scaling: from 0 to 20 million ([joind.in](https://joind.in/event/zgphp-meetup-99/scaling-from-0-to-20-million))
...
- `2014-06-19` [PHP Meetup](https://mi2.hr/en/2014/06/zgphp-meetup-33/) — Building distributed PHP applications ([video](https://zgphp.org/videos/josip-stuhli-building-distributed-applications/))
